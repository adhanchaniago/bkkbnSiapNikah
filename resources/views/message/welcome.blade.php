        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="{{route('message.welcome.create')}}" autocomplete="off">
                        @csrf
                        <div class="box-body">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="welcome-message" class="table table-bordered table-striped">
                            <thead>
                                <tr>
